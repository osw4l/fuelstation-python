var TableDatatablesManaged=function() {
    var e=function() {
        ...
        e.dataTable( {
            ...
            , bStateSave:!0, columnDefs:[ {
                targets: 0, orderable: !1, searchable: !1
            }
            ], lengthMenu:[[5, 15, 20, -1], [5, 15, 20, "Todos"]], pageLength:5, pagingType:"bootstrap_full_number", columnDefs:[ {
    ...
    t=function() {
        ...
        e.dataTable( {
            ...
            , bStateSave:!0, pagingType:"bootstrap_extended", lengthMenu:[[5, 15, 20, -1], [5, 15, 20, "All"]], pageLength:5, columnDefs:[ {
                orderable: !1, targets: [0]
            }
            , {
                searchable: !1, targets: [0]
    ...
    a=function() {
        ...
        e.dataTable( {
            ...
            , bStateSave:!0, lengthMenu:[[6, 15, 20, -1], [6, 15, 20, "All"]], pageLength:6, columnDefs:[ {
                orderable: !1, targets: [0]
            }
            , {
                searchable: !1, targets: [0]
